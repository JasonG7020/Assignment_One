...
var consolere = require('console-remote-client').connect('console.re','80','jasong7020_assignment_one');
...
function handleRequest(request, response){
    ...
    console.re.log("The current sum of 6 + 3 = " +sum);
}
...
server.listen(server_port, server_ip_address, function(){
    ...
    console.re.log("HTTP Server has started listening");
    ...
    console.re.log("HTTP Server has started listening on: " + server_ip_address + ":" + server_port);
});
